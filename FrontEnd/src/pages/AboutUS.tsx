    ...
    <>
      ...
      <div className="container py-16 md:py-24">
        ...
        <div className="mx-auto max-w-[58rem] text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground">The verification platform founded by Aniket Gupta</p>
        </div>
        ...
        <div className="mb-24">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-center bg-background/60 backdrop-blur border border-border/40 rounded-lg p-8">
            <div className="w-48 h-48 rounded-full bg-gradient-to-br from-primary/30 to-accent/30 flex items-center justify-center">
              <span className="text-4xl font-bold">AG</span>
            </div>
            <div>
              <h3 className="text-2xl font-bold mb-2">Aniket Gupta</h3>
              <p className="text-lg text-muted-foreground mb-4">Founder & CEO</p>
              <p className="text-muted-foreground mb-4">
                I am a third-year BSc IT undergraduate with a strong interest in artificial intelligence, full-stack development. Currently exploring real-world applications through hands-on projects and open-source contributions.
              </p>
              <p className="text-muted-foreground">

      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            ...
            <Link to="https://github.com/aniket-gupta-2005-12-31" className="text-gray-400 hover:text-white">
              <Github className="h-6 w-6" />
            </Link>
            <Link to="linkedin.com/in/aniket-gupta-technology-enthusiast" className="text-gray-400 hover:text-white">
